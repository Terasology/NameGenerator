 ...
 */
public enum RegionAdjectiveAssetTheme implements RegionAdjectiveTheme {

    /**
     * Default collection
     */
    DEFAULT("regionalAdjectives", "regionalPrefixes");
     ...
     */
    RegionAdjectiveAssetTheme(String namePrefab, String affixPrefab) {
     ...
     * @param affixPrefab valid prefab with {@link TownNameAffixComponent}
     */
    RegionAdjectiveAssetTheme(Prefab namePrefab, Prefab affixPrefab) {
