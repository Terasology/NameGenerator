 ...
 */
public class RegionAdjectiveAffinityVector implements AffinityVector {
     ...
     */
    protected RegionAdjectiveAffinityVector() {
     ...
     */
    public static RegionAdjectiveAffinityVector create() {
        return new RegionAdjectiveAffinityVector();
    }
     ...
     * @return this
     */
    public RegionAdjectiveAffinityVector type(double prefix, double postfix) {
