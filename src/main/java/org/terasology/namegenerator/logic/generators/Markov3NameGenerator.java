...
public class Markov3NameGenerator implements NameGenerator {
     ...
     */
    public Markov3NameGenerator(final AssetUri assetUri) {
     ...
     */
    public Markov3NameGenerator(String simpleUri) {
     ...
     */
    public Markov3NameGenerator(final List<String> sourceNames) {
