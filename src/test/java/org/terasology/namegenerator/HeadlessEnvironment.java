...
public abstract class HeadlessEnvironment {
    ...
    public static void setupEnvironment() throws Exception {
        ...
        if (!setup) {
            ...
            assetManager.addAssetSource(new ClasspathSource("unittest", HeadlessEnvironment.class.getProtectionDomain().getCodeSource(),
                    TerasologyConstants.ASSETS_SUBDIRECTORY, TerasologyConstants.OVERRIDES_SUBDIRECTORY));
...
//            CoreRegistry.put(ShaderManager.class, new ShaderManager()).initShaders();
            ...
            blockManager = new BlockManagerImpl(mock(WorldAtlas.class), blockFamilyFactoryRegistry);
